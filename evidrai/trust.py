...
def assessment_trust_snapshot(assessment: AssessmentResponse) -> Dict[str, Any]:
    ...
    return {
        ...
        "claim_semantics": settings.get("claim_semantics") or payload.get("reasoning", {}).get("claim_semantics") or {},
        "canonical_claim_key": (settings.get("claim_semantics") or payload.get("reasoning", {}).get("claim_semantics") or {}).get("canonical_claim_key", ""),
        "precision_note": (settings.get("claim_semantics") or payload.get("reasoning", {}).get("claim_semantics") or {}).get("precision_note", ""),
