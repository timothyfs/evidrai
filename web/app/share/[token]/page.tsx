...
export default async function SharedReportPage({ params }: SharePageProps) {
  ...
  return (
    <main>
      <header className="siteHeader printHidden"><a className="brand" href="/">Evidrai</a><nav className="staticNav"><a href="/product">Product</a><a href="/plans">Plans</a><a href="/about">About</a><a href="/">Verify another claim</a></nav></header>
